...
//
// Detailed usage document and tutorial available on the go-cpx Wiki page:
// https://github.com/cpexc/go-cpx/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
